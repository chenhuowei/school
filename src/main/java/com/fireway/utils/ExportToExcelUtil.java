...
public class ExportToExcelUtil {
        ...
        while (it.hasNext()) {  
            ...
            for (int x = 0; x < propertys.length; x++) {  
                ...
                if (map.containsKey(property)) {  
                    ...
                    rw.createCell(x + 1).setCellValue(value.toString());  
                } else {  
     ...
     */  
    @SuppressWarnings("rawtypes")  
    public static void exportView(HttpServletResponse response, List list, String[] columns, String[] propertyNames,String fileName) throws IOException, UnsupportedEncodingException, Exception {  
        ...
        String fileName2 = fileName+"-"+sdf.format(new Date()) + ".xls";  
