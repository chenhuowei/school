...
var scoreFuntion = function(studentId,classId,grade){
	var schoolYear = '';
	var term = '';
...
function openWin(id,isHidden){
	...
	var form = new Ext.FormPanel({
	    	    ...
	    	    },
	    {
	        ...
	        layout: "vbox",
	        items: [
				{ xtype: "combobox", name: "subjectArrangementId",id:'subjectArrangementId', fieldLabel:"考试科目",allowBlank:false,emptyText: '选择...',editable:false, padding:0,
				 	forceSelection:false,selectOnFocus : true,width:366,labelWidth:30,
				 	store:Ext.create('Ext.data.Store', {
				         fields: ["value", "name"],
				            proxy: {
				                type: 'ajax',
				                url: basePath+'subjectArrangement/findByClassId.do?classId='+classId
